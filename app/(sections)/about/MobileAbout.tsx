...
export default function MobileAbout() {
  ...
  return (
    <div
      ref={ref}
      id="about-mobile"
      className="relative w-full min-h-screen bg-gradient-to-r from-[#dfffd9] via-[#f5f5f5] to-[#ffcae7] px-4 py-16 flex flex-col justify-center"
    >
      <div className="w-full max-w-md mx-auto flex flex-col gap-6">
        ...
        >
          ...
          <div className="flex items-center gap-1 mb-2">
            ...
            <span
              className="text-sm leading-[1.588] tracking-[-0.48px] text-black"
              style={{
                fontFamily: "Inter, SF Pro Display, SF Pro Text, sans-serif",
              }}
            >
          ...
          {/* Description */}
          <p
            className="text-base font-normal leading-[1.588] tracking-[-0.56px] text-black text-center"
            style={{
              fontFamily: "Inter, SF Pro Display, SF Pro Text, sans-serif",
            }}
          >
