    ...
    <div className="flex flex-col items-end gap-8">
      ...
      <div className="relative w-full h-[480px] bg-[#5c5c5c] rounded-[20px] overflow-hidden">
        ...
        <div className="absolute bottom-[50px] left-1/2 -translate-x-1/2 flex items-center gap-5">
          {/* Pagination Dots */}
          <div className="bg-[#323234] rounded-full px-5 py-5 flex items-center gap-3">
          ...
          <button
            ...
            className="relative w-14 h-14 bg-[#323234] rounded-full flex items-center justify-center hover:bg-[#424244] transition-colors"
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          className="w-10 h-10 bg-[#333336] rounded-full flex items-center justify-center hover:bg-[#434346] transition-colors opacity-36 hover:opacity-100"
        ...
        <button
          onClick={goToNext}
          className="w-10 h-10 bg-[#333336] rounded-full flex items-center justify-center hover:bg-[#434346] transition-colors"
