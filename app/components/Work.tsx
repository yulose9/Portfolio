...
export default function Work() {
  return (
    ...
    >
        ...
        <div className="max-w-[1280px] mx-auto w-full">
          ...
          <div className="w-full">
            ...
            {workExperiences.map((work, index) => (
              ...
              >
                <p
                  className="text-[14px] font-light leading-[24px] tracking-[-0.56px] text-white whitespace-nowrap"
                  style={{ fontFamily: "Inter, SF Pro Text, sans-serif" }}
                >
                  {work.duration}
                </p>
      ...
      {/* Certificates & Licenses Section - Full Screen */}
      <section className="relative min-h-screen flex flex-col justify-center px-8 py-16">
        <div className="max-w-[1280px] mx-auto w-full">
          {/* Certificates Header */}
